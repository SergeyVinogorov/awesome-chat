...
// import { handleSignInAction } from '../models/LoginDto/actions.js';
import { handleError } from "../models/AppDto.js";
var LoginPageController = /** @class */ (function (_super) {
    __extends(LoginPageController, _super);
    function LoginPageController(props) {
    ...
    LoginPageController.prototype.init = function () {
        // if(this.store.appReducer.isAuth) {
        //   router.go('/chats', 'Страница чатов')
        // }
    };
    LoginPageController.prototype.activate = function () {
        this.setState({
            login: {
                value: '',
                isValid: true,
    ...
    LoginPageController.prototype.handleValidate = function (event, type, name) {
    ...
    LoginPageController.prototype.handleFormData = function (e) {
        return __awaiter(this, void 0, void 0, function () {
            var methodStore, login, password, params;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        e.preventDefault();
                        methodStore = this.state;
                        login = this.validatorService.validateValue(methodStore.login.value, 'email');
                        password = this.validatorService.validateValue(methodStore.password.value, 'password');
                        if (!(login.isValid && password.isValid)) return [3 /*break*/, 2];
                        params = {
                            login: login.value,
                            password: password.value
                        };
                        return [4 /*yield*/, this.auth.signIn(params)];
                    case 1:
                        _a.sent();
                        _a.label = 2;
