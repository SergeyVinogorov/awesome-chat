    ...
    return Didact.createElement('div', { className: 'mf-page' }, [
        Didact.createElement('div', { className: 'mf-side-bar' }, [
            Didact.createElement('div', { className: 'mf-side-bar__header' }, [
                ...
                new Button({
                    ...
                    onclick: () => ctrl.handleSearch('right'),
                    children: [
                        Didact.createElement(
                            'img',
                            {
        ...
        Didact.createElement('main', { className: 'mf-chat' }, [
            Didact.createElement('div', { className: 'mf-chat__header' }, [
                Didact.createElement(
                    'div',
                    { className: 'mf-chat__companion' },
                    [
                        Didact.createElement(
                            'div',
                            { className: 'mf-chat__companion-image' },
                            ''
                        ),
                        Didact.createElement('div', {}, [
                            Didact.createElement(
                                'h5',
                                { className: 'mf-chat__companion-title' },
                                'Вадим'
                            ),
                            Didact.createElement(
                                'p',
                                { className: 'mf-chat__companion-text' },
                                'Был 5 минут назад'
                            ),
                        ]),
                    ]
            ...
            Didact.createElement('div', { className: 'mf-chat__body' }, [
                ...
                Didact.createElement('p', { className: 'mf-chat__message' }, [
                    ...
                    Didact.createElement(
                        'span',
                        { className: 'mf-chat__message-time' },
                        '11:56'
                    ),
                ]),
                Didact.createElement(
                    'div',
                    { className: 'mf-chat__image-message' },
                    [
                        Didact.createElement(
                            'img',
                            { src: './images/camera.jpg', alt: 'моя камера' },
                            ''
                        ),
                        Didact.createElement(
                            'span',
                ...
                Didact.createElement('div', { className: 'mf-chat__answer' }, [
                    Didact.createElement(
                        'p',
                        { className: 'mf-chat__answer-text' },
                        'Круто!'
                    ),
                    ...
                    Didact.createElement(
                        'input',
                        {
                            ...
                            oninput: (e: Event) => {
                                ...
                                let validated = ctrl.handleOnInput(
                                    target,
                                    'text'
                                );
